 ...
 */
const createOrder = async (totalAmount, cart) => {
...
/**
 * Creates an order object based on the provided cart array.
 *
 * @param {Array} cartArray - The array of items in the cart.
 * @returns {Array} - The order object array.
 * @throws {Error} - If any required item data (accommodation or price) is missing.
 */
